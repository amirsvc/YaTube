# Generated by Django 2.2.16 on 2022-09-29 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, help_text='Группа, к которой будет относиться пост', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='groups_name', to='posts.Group', verbose_name='Группа')),
            ],
            options={
